      ...
      <div class="row g-0">
        <div class="col-md-6 border-end">
          <div class="d-flex flex-column justify-content-center">
            ...
            <div class="thumbnail_images">
              <ul id="thumbnail">
                <li><img src="https://i.imgur.com/TAzli1U.jpg" width="70"></li>
                <li><img src="https://i.imgur.com/w6kEctd.jpg" width="70"></li>
                <li><img src="https://i.imgur.com/L7hFD8X.jpg" width="70"></li>
                <li><img src="https://i.imgur.com/6ZufmNS.jpg" width="70"></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="p-3 right-side">
            <div class="d-flex justify-content-between align-items-center"><h3>IIlana</h3>  <span class="heart"><i
                class='bx bx-heart'></i></span></div>
            <div class="mt-2 pr-3 content"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
