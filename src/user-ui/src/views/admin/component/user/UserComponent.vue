<template>
  ...
  <div class="row">
    <div class="input-group mb-3 col">
      <input type="text" class="form-control" placeholder="Mời bạn nhập email hoặc username" v-model="request.email">
    ...
    <table class="table table-bordered table-hover table-striped">
      ...
      <tbody>
        <tr  class="align-middle" v-for="item in userList.content">
          ...
          <td>
            <button class="btn btn-success btn-sm m-1" @click.prevent="$refs.userDetail.openModal();user = item; isUpdate= true">
              <i class="bi bi-pencil-fill"></i>
            </button>
...
<user-detail-component :user="user" ref="userDetail" :is-update="isUpdate" @added-user="userAdded"></user-detail-component>
</template>
