<template>
	...
	<button v-show="false" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create-user"
	        id="show-modal">
				...
				<div class="modal-body">
					<form @submit.prevent="addUser()">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" id="floatingUsername" v-model="user.username"
							       :disabled="isUpdate">
							<label for="floatingUsername">Tài khoản</label>
						</div>
						<div class="form-floating mb-3">
							<input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
							       v-model="user.email" :disabled="isUpdate">
							<label for="floatingInput">Email</label>
						</div>
						<div class="form-floating mb-3">
							<input v-if="!isUpdate" type="password" class="form-control" id="floatingPassword"
